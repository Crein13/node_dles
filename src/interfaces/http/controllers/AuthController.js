...
class AuthsController extends BaseController {
  ...
  constructor() {
    super();
    const router = Router();
    // router.get('/', this.injector('ListAuths'), this.index);
    // router.post('/', this.injector('CreateAuth'), this.create);
    // router.get('/:id', this.injector('ShowAuth'), this.show);
    // router.put('/:id', this.injector('UpdateAuth'), this.update);
    // router.delete('/:id', this.injector('DeleteAuth'), this.delete);
